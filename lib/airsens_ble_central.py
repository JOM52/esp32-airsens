...
v0.1.20 : 04.07.2022 --> aimproved the management of wifi connection in "main"
"""
VERSION = '0.1.20'
...
#     
    try:
        ...
        n_essais = 0
        while not my_wifi.isconnected_wifi():
            sleep_ms(200)
            my_wifi.connect_wifi()
            n_essais += 1
        if n_essais > 0:
            log.log_error('main wait on wifi connection: ' + str(n_essais))
